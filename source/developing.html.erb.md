...
Use responsive design to adapt the display to different zoom states and viewport sizes, such as on mobile devices and tablets. Avoid clipping and horizontal scrolling when the font size is increased. Use progressive enhancement to help ensure that core functionality and content are available regardless of technology being used.
